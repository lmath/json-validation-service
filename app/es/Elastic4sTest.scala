...
//
//object Elastic4sTest extends App {
//
...
//  client.execute {
//    createIndex("schemas").mapping(
//      properties(
//        fields = Seq(TextField("name"))
//      )
//    )
//  }.await
//
...
//  client.execute {
//    indexInto("artists").fields("name" -> "L.S. Lowry").id("8238ca79-a0f8-425f-8674-e9fb9326ca03").refresh(RefreshPolicy.Immediate)
//  }.await
//
